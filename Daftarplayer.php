...
if (isset($_POST['submit'])) {
	...
	$kuari = mysqli_query($koneksi,"SELECT * FROM team WHERE nama_team = '$poi'");
	$data = mysqli_fetch_assoc($kuari);
	if ($data['password'] == $password) {
		$masuk = mysqli_query($koneksi,"INSERT INTO player VALUES ('','$nama','$role','$poi')");
		if ($masuk) {
			echo "<script>
			alert('berhasil');
...
<body>
	...
	<div class="jumbotron jumbotron-fluid" style=" background-color: rgba(26, 26, 26, 1);  color: white;">
		<div class="container">
			<h1 class="bold" align="center">Daftar player</h1>
			<br><br>
			<form method="POST">
				<div class="form-group">
					<label for="exampleFormControlInput1">Nama/username</label>
					<input style=" background-color: black; color: white;" name="nama" type="text" class="form-control" id="exampleFormControlInput1" placeholder="masukan nama/usernmae ">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input style=" background-color: black; color: white;" name="role" type="text" class="form-control" id="exampleFormControlInput1" placeholder="masukan nama role anda ">
				</div>
